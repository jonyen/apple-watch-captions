...
///
/// Tuning in is a *wait*: the screen is opened by choice, and polling it is
/// what tells the relay the watch is here to receive audio. Without a state of
/// its own that wait rendered as a blank caption view whose indicator read
/// "Tuned in" — claiming audio that did not exist — and the talk gesture was
/// live throughout, recording into a turn the relay could only refuse.
struct CallWaitingView: View {
    ...
    var body: some View {
        ...
        .accessibilityLabel("Waiting for audio. Keep this screen open.")
        .toolbar {
